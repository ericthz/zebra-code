...
func TestLoadInstructionsBasic(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "ZEBRACODE.md"), "root zebracode rules")
	mustWrite(t, filepath.Join(dir, "AGENTS.md"), "root agents rules")
	mustWrite(t, filepath.Join(dir, ".zebracode", "INSTRUCTIONS.md"), "legacy instructions")

	out := LoadInstructions(dir)
	for _, want := range []string{"root zebracode rules", "root agents rules", "legacy instructions"} {
...
func TestLoadInstructionsWalksUp(t *testing.T) {
	...
	mustWrite(t, filepath.Join(root, "ZEBRACODE.md"), "from root")
	mustWrite(t, filepath.Join(sub, "ZEBRACODE.md"), "from leaf")
...
func TestExpandIncludesResolvesRelative(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "ZEBRACODE.md"), "header\n@./rules/style.md\nfooter\n")
...
func TestExpandIncludesIgnoresCycles(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "ZEBRACODE.md"), "@./a.md\n")
...
func TestExpandIncludesSkipsInsideCodeFences(t *testing.T) {
	...
	mustWrite(t, filepath.Join(dir, "ZEBRACODE.md"), "```\n@./skipped.md\n```\n")
