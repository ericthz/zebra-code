...
type Deps struct {
	MemoryDir     string                  // <wd>/.zebracode/memory/ — project/reference (trailing sep)
	UserMemoryDir string                  // ~/.zebracode/memory/ — user/feedback (trailing sep); may be "" if $HOME unresolved
