...
func TestBuildExtractAutoOnlyPromptMarkers(t *testing.T) {
	got := BuildExtractAutoOnlyPrompt(7, "", false, "/home/test/.zebracode/memory/", "/tmp/proj/.zebracode/memory/")
...
func TestBuildExtractAutoOnlyPromptSkipIndex(t *testing.T) {
	got := BuildExtractAutoOnlyPrompt(5, "", true, "/home/test/.zebracode/memory/", "/tmp/proj/.zebracode/memory/")
...
func TestBuildExtractAutoOnlyPromptIncludesExistingManifest(t *testing.T) {
	...
	got := BuildExtractAutoOnlyPrompt(3, manifest, false, "/home/test/.zebracode/memory/", "/tmp/proj/.zebracode/memory/")
